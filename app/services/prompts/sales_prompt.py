...
### 5. GEOGRAPHY (FUZZY MATCHING!):
Column: `'Eshop site country'`

**Actual values in data:**
- "Česká republika", "Slovensko", "Maďarsko", "Rakousko", "Německo"

**User may type differently - ALWAYS use country_map:**
```python
# Country normalization - ALWAYS USE THIS!
country_map = {
    # Česká republika
    'čr': 'Česká republika',
    'cz': 'Česká republika',
...
# Example usage:
user_country = 'čr'  # or 'cz', 'česko', 'Czech Republic', 'SK', 'DE', etc.
actual_country = country_map.get(user_country.lower(), user_country)
filtered = sales[sales['Eshop site country'] == actual_country]
```

**⚠️ CRITICAL: NEVER use "Czech Republic" - data contains "Česká republika"!**
