...
```python
ALZAPLUS_MEMBER = "AlzaPlus+"
sales_plus = sales[sales['AlzaPlus+'] == ALZAPLUS_MEMBER]
docs_plus = docs[docs['AlzaPlus+'] == ALZAPLUS_MEMBER]
aov = sales_plus[jan_col].sum() / docs_plus[jan_col].sum()
```
Apply SAME filters to both Sales and Documents!
